...
func (a *App) currentTheme() ui.Theme {
	...
	case themeDark:
		return ui.DarkTheme()
	case themeSystem:
		// Omarchy's default desktop is Tokyo Night. Keep the app's default
		// presentation stable across host OS light/dark preferences; users can
		// still explicitly opt into the existing light theme in Settings.
		return ui.DarkTheme()
	default:
		return ui.DarkTheme()
	}
